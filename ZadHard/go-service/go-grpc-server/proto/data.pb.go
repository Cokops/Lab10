...
func (x *DataResponse) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *DataResponse) GetDetails() map[string]string {
	if x != nil {
		return x.Details
	}
	return nil
...
const file_proto_data_proto_rawDesc = "" +
	"\n" +
	"\x10proto/data.proto\x12\x05proto\"+\n" +
	"\vDataRequest\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\tR\ttimestamp\"\xaa\x01\n" +
	"\fDataResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12:\n" +
	"\adetails\x18\x03 \x03(\v2 .proto.DataResponse.DetailsEntryR\adetails\x1a:\n" +
	"\fDetailsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x012H\n" +
	"\vDataService\x129\n" +
	"\x0eGetComplexData\x12\x12.proto.DataRequest\x1a\x13.proto.DataResponseB\tZ\a./protob\x06proto3"
...
var file_proto_data_proto_goTypes = []any{
	...
	nil,                  // 2: proto.DataResponse.DetailsEntry
}
var file_proto_data_proto_depIdxs = []int32{
	2, // 0: proto.DataResponse.details:type_name -> proto.DataResponse.DetailsEntry
	0, // 1: proto.DataService.GetComplexData:input_type -> proto.DataRequest
	1, // 2: proto.DataService.GetComplexData:output_type -> proto.DataResponse
